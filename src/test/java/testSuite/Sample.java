...
public class Sample {
	...
	public int totalSpecScore,totalAPIScore,totalapiperf;
	public double specperc,apiperc,apiperfperc;
	...
	public void setup()
	{
		htmlReporter = new ExtentHtmlReporter("./Report/User Assignment Report.html");
	...
	public void specification() throws InterruptedException
	{
			...
			addInsuranceT=given()
					.contentType("application/json")
					.body("{\"userName\": \"xxxx\",\"phoneNumber\": 1234567890,\"carType\": \"maruti-Ritz\",\"fuelType\": \"diesel\",\"registrationState\": \"Chhattisgarh\",\"plan\": {\"name\": \"Bajaj Allianz\",\"price\": 12500}}")
					.when().post(addInsurance).timeIn(TimeUnit.MILLISECONDS);
			apiPerf.log(Status.PASS, "<b>"+addInsurance+"</b><br/>"
					+ "API POST Request <br/> Response Time:<br/>"+addInsuranceT+" ms"
					+ "<br/><b>Score 35/35</b>");
			p1=35;
			...
			getDetails2T=given()
					.contentType("application/json")
					.when().get(getDetails).timeIn(TimeUnit.MILLISECONDS);
			apiPerf.log(Status.PASS, "<b>"+getDetails+"</b><br/>"
					+ "API POST Request <br/> Response Time:<br/>"+getDetails2T+" ms"
					+ "<br/><b>Score 35/35</b>");
			p2=35;
			...
			getDetails3T=given()
					.contentType("application/json")
					.when().get("http://localhost:3000/api/getQuotes").timeIn(TimeUnit.MILLISECONDS);
			apiPerf.log(Status.PASS, "<b>http://localhost:3000/api/getQuotes</b><br/>"
					+ "API POST Request <br/> Response Time:<br/>"+getDetails3T+" ms"
					+ "<br/><b>Score 30/30</b>");

			p3=30;

			totalapiperf=p1+p2+p3;
			apiperfperc=(totalapiperf*100)/100;

			//Main Code Quality Tab

			codeQuality=extent.createTest("<b>Code Quality</b>");
			codeQuality.log(Status.PASS, "<table border=\"1\"> <tr> <td><b>Reliability</b></td> <td>45 %</td> </tr> <tr> <td><b>Security</></td> <td>25 %</td> </tr> "
					+ "<tr> <td><b>Maintainability</b></td> <td>100 %</td> </tr> <tr> <td><b>Coverage</b></td> <td>0.0 %</td> </tr>"
			...
			skillTest.log(Status.PASS, "<table border=\"1\"> <tr> <td><b>Features</b></td> <td><b>Status</b></td><td><b>Test Scenario ID's</b></td> <td><b>Weightage</b></td> <td><b>Score</b></td></tr>"
					...
					+"<tr><td>jQuery AJAX, JSON</td>"+status12+"<td>TS04,TS10,TS11,TS12,TS17,TS18,TS22</></td> <td>100</td><td>"+skill12score+"</></td></tr>"
					+"</table> ");
			...
			appQuality.log(Status.PASS, "<table border=\"1\"> <tr> <td><b>Specification</b></td> <td>"+specperc+" %</td> </tr> <tr> <td><b>API Accuracy</></td> <td>"+apiperc+" %</td> </tr> "
					+ "<tr> <td><b>API Performance</b></td> <td>"+apiperfperc+" %</td> </tr> <tr> <td><b>Responsiveness</b></td> <td>100 %</td> </tr></table>");
